...
export async function generateMetadata(props) {
  ...
  const title = LEÇONS[lecon - 1] || "Formation Excel Expert";
  
  return {
    title: `${title}`,
    description: `Découvrez la leçon ${lecon} : ${title} sur ExcelDuZero. Devenez un expert sur Excel.`,
    alternates: {
      canonical: `https://excelduzero.com/cours/expert?lecon=${lecon}`
    }
  };
}
