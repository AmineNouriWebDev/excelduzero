...
const questions = [
  {
    question: "Dans une série linéaire, comment Excel détermine-t-il le pas de la série ?",
    options: [
  ...
  {
    question: "Pour créer une série chronologique avec un pas de 7 jours, que devez-vous faire après avoir saisi la première date ?",
    options: [
  ...
  {
    question: "Dans une série alphanumérique comme 'Eleve 1.5', quel nombre Excel va-t-il incrémenter ?",
    options: [
      "Le nombre 1",
  ...
  {
    question: "Pour créer une série géométrique, quelle méthode est obligatoire ?",
    options: [
  ...
  {
    question: "Où trouve-t-on l'option pour créer des listes personnalisées dans Excel ?",
    options: [
  ...
  return (
    <div className="mt-8 p-6 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="font-bold text-blue-800">Quiz : Séries de données Excel</div>
      </div>
