...
import QuizLecon2 from "../../quizz/debutant/QuizLecon2";
import { 
  MousePointer2, 
  Edit3, 
  Type, 
...
export default function Lecon2({ onResult }) {
  ...
  if (showQuiz) {
    return <QuizLecon2 onComplete={handleQuizComplete} />;
  }
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white">
      ...
      <section id="selection" className="mb-12">
        ...
        <div className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ImageZoomable
              src="/cours/debutant/lecon2/selection_cellule_excel.gif"
          ...
          <div className="mb-6">
            ...
            <div className="mb-4">
              ...
              <ImageZoomable
                src="/cours/debutant/lecon2/selection_plage_cellule_adjacente_excel.gif"
            ...
            <div className="mb-4">
              ...
              <ImageZoomable
                src="/cours/debutant/lecon2/selectionner_cellules_non_adjacente.gif"
      ...
      <section id="saisie" className="mb-12">
        ...
        <div className="mb-8">
          ...
          <ImageZoomable
            src="/cours/debutant/lecon2/validation_saisie_excel.gif"
        ...
        <div className="mb-8">
          ...
          <ImageZoomable
            src="/cours/debutant/lecon2/saisie_multilple_excel.gif"
      ...
      <section id="modification" className="mb-12">
        ...
        <div className="mb-8">
          ...
          <ImageZoomable
            src="/cours/debutant/lecon2/modification_cellule_excel.gif"
      ...
      <section id="rechercher" className="mb-12">
        ...
        <div className="mb-8">
          ...
          <ImageZoomable
            src="/cours/debutant/lecon2/rechercher_remplacer_excel.gif"
      ...
      <section id="orthographe" className="mb-12">
        ...
        <ImageZoomable
          src="/cours/debutant/lecon2/verification_orthographe_excel.gif"
      ...
      <section id="insertion" className="mb-12">
        ...
        <div className="mb-8">
          ...
          <ImageZoomable
            src="/cours/debutant/lecon2/insertion_ligne_excel.gif"
