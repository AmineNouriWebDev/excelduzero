    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white">
          ...
          <div className="mb-8">
            ...
            <ImageZoomable 
              src="/cours/debutant/lecon13/addition.gif" 
          ...
          <div className="mb-8">
            ...
            <ImageZoomable 
              src="/cours/debutant/lecon13/fonctions_simples.gif" 
          ...
          <div className="mb-12">
            ...
            <div className="mb-8">
              ...
              <ImageZoomable 
                src="/cours/debutant/lecon13/operateurs_excel.gif" 
          ...
          <div className="mb-12">
            ...
            <div className="mb-8">
              ...
              <ImageZoomable 
                src="/cours/debutant/lecon13/reference_relative.gif" 
              ...
              <div className="mb-6">
                ...
                <ImageZoomable 
                  src="/cours/debutant/lecon13/recopie_verticale.gif" 
              ...
              <div className="mb-6">
                ...
                <ImageZoomable 
                  src="/cours/debutant/lecon13/recopie_horizontale.gif" 
            ...
            <div className="mb-8">
              ...
              <ImageZoomable 
                src="/cours/debutant/lecon13/reference_absolue.png" 
              ...
              <ImageZoomable 
                src="/cours/debutant/lecon13/reference_absolue.gif" 
          ...
          <div className="mb-12">
            ...
            <div className="bg-green-50 p-6 rounded-lg mb-6">
              ...
              <ImageZoomable 
                src="/cours/debutant/lecon13/exemple.png" 
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <PremiumVideo url="/cours/debutant/lecon13/exemple.mp4" title="Correction vidéo de l'exemple pratique" />
            </div>
          </div>
            <div className="mt-12">
