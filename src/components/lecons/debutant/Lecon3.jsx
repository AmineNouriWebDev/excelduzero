...
import QuizLecon3 from "../../quizz/debutant/QuizLecon3";
import { 
  MousePointer2, 
  Edit3, 
  Type, 
...
export default function Lecon3({ onResult }) {
  ...
  if (showQuiz) {
    return <QuizLecon3 onComplete={handleQuizComplete} />;
  }
  ...
  return (
    ...
    <div className="mb-8">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5 mb-4">
        ...
        <ImageZoomable 
          src="/cours/debutant/lecon3/serie_numerique_lineaire_excel.gif" 
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-5 mb-6">
        ...
        <ImageZoomable 
          src="/cours/debutant/lecon3/serie_numerique_lineaire_constante_excel.gif" 
    ...
    <ImageZoomable 
      src="/cours/debutant/Lecon3/serie_chronologique_excel.gif" 
    ...
    <ImageZoomable 
      src="/cours/debutant/Lecon3/serie_alphanumerique_excel.gif" 
    ...
    <div className="space-y-6">
      <div className="bg-white border border-gray-200 rounded-lg p-5">
        ...
        <ImageZoomable 
          src="/cours/debutant/Lecon3/fenetre_liste_personnalisee.png" 
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5">
        ...
        <ImageZoomable 
          src="/cours/debutant/Lecon3/creer_liste_personnalisee_exccel.gif" 
