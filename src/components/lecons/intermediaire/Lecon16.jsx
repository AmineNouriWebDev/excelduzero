...
export default function Lecon16({ onResult }) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-teal-500 to-emerald-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">Solveur Excel : Optimisation Avancée</h1>
                <p className="text-xl opacity-90 mt-2">Maximisez vos résultats, Maîtrisez les contraintes, Prenez les meilleures décisions</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              ...
              <p className="font-semibold">Optimisation</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              <Box className="w-6 h-6 mb-2" />
              <p className="font-semibold">Contraintes</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              <Workflow className="w-6 h-6 mb-2" />
              <p className="font-semibold">Algorithmes</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              <LineChart className="w-6 h-6 mb-2" />
              <p className="font-semibold">Solutions Optimales</p>
            </div>
          </div>
        </div>
      </div>
