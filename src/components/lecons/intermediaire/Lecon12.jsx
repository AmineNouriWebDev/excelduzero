...
export default function Lecon12({ onResult }) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-green-600 to-teal-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">Tableaux de Bord Simples</h1>
                <p className="text-xl opacity-90 mt-2">Transformer des données brutes en insights actionnables</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              ...
              <p className="font-semibold">TCD & Graphiques</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              <Filter className="w-6 h-6 mb-2" />
              <p className="font-semibold">Segments Interactifs</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              <Zap className="w-6 h-6 mb-2" />
              <p className="font-semibold">Mise à Jour Automatique</p>
            </div>
          </div>
        </div>
      </div>
