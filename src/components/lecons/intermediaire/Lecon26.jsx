...
export default function Lecon26({ onResult }) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-0 bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-green-500 to-teal-400 rounded-2xl px-4 py-4 md:p-6 md:rounded-lg rounded-none md:px-4 py-6 md:p-8 md:rounded-xl rounded-none mb-8 text-white relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base md:text-2xl md:text-4xl font-bold break-words">Fonctions Date et Heure Excel : Maîtriser le Temps</h1>
      ...
      <div className="border-2 border-gray-100 rounded-2xl overflow-hidden mb-8 bg-gradient-to-br from-white to-blue-50/30">
        ...
        {expandedSections.introduction && (
          <div className="px-4 py-6 md:p-8 md:rounded-xl rounded-none">
            ...
            {/* Section Avantages */}
            <div className="mt-8 bg-gradient-to-r from-green-500 to-teal-500 rounded-2xl px-4 py-4 md:p-6 md:rounded-lg rounded-none text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-white/20 p-4 rounded-lg backdrop-blur-sm">
                  <div className="text-base md:text-2xl font-bold mb-1">5x</div>
                  <p className="text-sm opacity-90">Gain de productivité</p>
                </div>
                <div className="bg-white/20 p-4 rounded-lg backdrop-blur-sm">
                  <div className="text-base md:text-2xl font-bold mb-1">0</div>
