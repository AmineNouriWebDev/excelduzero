...
export default function Lecon25({ onResult }) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-0 bg-white">
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-500 to-blue-400 rounded-2xl px-4 py-4 md:p-6 md:rounded-lg rounded-none md:px-4 py-6 md:p-8 md:rounded-xl rounded-none mb-8 text-white relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base md:text-2xl md:text-4xl font-bold break-words">Fonctions Texte Excel : GAUCHE, DROITE, STXT</h1>
      ...
      <div className="border-2 border-gray-100 rounded-2xl overflow-hidden mb-8 bg-gradient-to-br from-white to-indigo-50/30">
        ...
        {expandedSections.introduction && (
          <div className="px-4 py-6 md:p-8 md:rounded-xl rounded-none">
            ...
            {/* Section Avantages */}
            <div className="mt-8 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl px-4 py-4 md:p-6 md:rounded-lg rounded-none text-white">
