...
export default function Lecon17({ onResult }) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-white">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-fuchsia-500 to-pink-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">Macros Excel : Automatisation Intelligente</h1>
                <p className="text-xl opacity-90 mt-2">Enregistrez, Exécutez, Automatisez - Gagnez un temps précieux</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              ...
              <p className="font-semibold">Enregistrement</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
            ...
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
              ...
              <p className="font-semibold">Automatisation</p>
            </div>
            <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
